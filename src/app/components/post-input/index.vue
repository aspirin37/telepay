<template>
  <div class="wrap">
    ...
    <div class="form-row mt-2" :key="btn[0].id" v-for="btn in buttons">
      <div class="col">
        <input class="form-control" type="text" v-model="btn[0].text" placeholder="Текст кнопки"></div>
      <div class="col">
        <input class="form-control" type="text" v-model="btn[0].url" placeholder="Ссылка"></div>
      <div class="col-1">
        <button class="btn" @click="removeButton(btn[0].id)">
