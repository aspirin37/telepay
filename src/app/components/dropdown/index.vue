<template>
    <div class="v-dropdown position-relative" ref="wrap">
        <!-- <span class="v-dropdown__angle fa fa-2x fa-angle-down"></span> -->
        <div class="v-dropdown__angle d-flex align-items-center pointer" v-html="Angle"></div>
        <div class="v-dropdown__trigger" ref="trigger">
            <slot name="trigger"></slot>
        </div>
        <transition name="v-dropdown">
            <div class="v-dropdown__body" :class="classes" v-show="visible">
                <slot name="body"></slot>
            </div>
        </transition>
    </div>
