    ...
    async deleteTimeFrames(alert) {
      ...
      if (alert) {
        swalOut = await swal({
          ...
          html:
            'Канал не будет виден в каталоге.<br>Все посты на этом канале <b>ожидающие постинга</b> будут опубликованы.<br>Все посты <b>ожидающие подтверждения</b> будут отклонены.',
